...
class ZMCollectionViewCell: UICollectionViewCell {
    ...
    var cellModel: ZMKeyBoadModel! {
        didSet{
            ...
            keyBoardButton.backgroundColor = cellModel.backgroundColor
        }
    }
    ...
    lazy var keyBoardButton : UIButton = {
        let object = UIButton()
        //设置相关属性
        object.setTitleColor(ColorExtension().largeGray, for: .normal)
        object.titleLabel?.font = UIFont.init(name: "PingFangSC-Semibold", size: 24)
        object.backgroundColor = UIColor.white
        
        //设置圆角
        object.layer.cornerRadius = 5
        object.layer.shadowOffset = CGSize.init(width: 0, height: 2)
        object.layer.shadowOpacity = 0.6
        object.layer.shadowRadius = 1
        object.layer.shadowColor = ColorExtension().largeGray.cgColor
